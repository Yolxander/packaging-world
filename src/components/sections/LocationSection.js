    ...
    return (
        <div className="bg-white py-12">
            <div className="container mx-auto px-4">
                <div className="bg-[#3a4e9d] text-white rounded-lg shadow-lg p-8 flex flex-col md:flex-row items-center">
                    <div className="w-full md:w-1/2 md:pr-8 mb-6 md:mb-0">
                        <h2 className="text-3xl font-bold mb-4">Visit Our Warehouse</h2>
                        <p className="mb-6">
                            Come by and explore our products in person. We are located in Toronto and open Monday to Friday from 9 AM to 5 PM.
                        </p>
                        ...
                        <div className="flex space-x-4 mt-6">
                            <Button variant="outline" className="text-black border-white hover:bg-white hover:text-[#1b4541]">
                                Get Directions
                            </Button>
                        </div>
                    </div>
